...
-- BOTÃO PARKOUR - AGORA EXECUTA O SCRIPT QUE VOCÊ QUER
...
-- ============================================
-- FUNÇÃO PARA EXECUTAR O SCRIPT DO PARKOUR
-- ============================================
local function executarParkour()
    -- Este é o script completo do parkour que você me mandou
    -- com o título já alterado para "COMANDO EJ"
    
    local function nBlqztqsqboOHaKygfGOfEqhFZSYCseZtn(code)
        local res = ''
    ...
    local LocalData = {
        ...
        {pos = Vector3.new(172.90, 53.26, -900.06), size = Vector3.new(5.00, 0.50
